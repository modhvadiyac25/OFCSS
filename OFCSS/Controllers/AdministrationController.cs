...
namespace OFCSS.Controllers
{
    public class AdministrationController : Controller
    {
        ...
        public AdministrationController(AppDbContext context, RoleManager<IdentityRole> roleManager, UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager)
        {
